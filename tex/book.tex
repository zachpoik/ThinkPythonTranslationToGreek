...
\index{index}
Ένα {\bf λεξικό} μοιάζει με μία λίστα, αλλά είναι κάπως πιο γενικό. Σε μία λίστα, οι δείκτες πρέπει να είναι ακέραιοι αριθμοί αλλά σε ένα λεξικό μπορούν να είναι σχεδόν οποιουδήποτε τύπου.

Μπορείτε να φανταστείτε ένα λεξικό σαν μία αντιστοίχιση μεταξύ ενός συνόλου δεικτών (οι οποίοι ονομάζονται {\bf κλειδιά}) και ενός συνόλου τιμών. Κάθε κλειδί αντιστοιχεί σε μία τιμή. Αυτή η σχέση ονομάζεται {\bf ζευγάρι κλειδιού-τιμής} ή μερικές φορές {\bf στοιχείο}. 
...
\end{verbatim}
%
Για να δείτε αν κάτι εμφανίζεται σαν τιμή σε ένα λεξικό μπορείτε αρχικά να εφαρμόσετε τη μέθοδο {\tt values}, η οποία επιστρέφει τις τιμές σαν μία λίστα, και μετά χρησιμοποιώντας τον τελεστή {\tt in}:
\index{values method}
\index{method!values}
